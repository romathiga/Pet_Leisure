<?php
    ...
    if(isset($_POST['update'])){
        ...
        $idade_animal2 = $_REQUEST['idade_animal_2'];
        $idade_animal3 = $_REQUEST['idade_animal_3'];
        ...
        $sql_update ="UPDATE usuario_dono_pet SET  nome ='$nome', telefone='$telefone', tipo_animal_1='$tipoAnimal1', tipo_animal_2='$tipoAnimal2', tipo_animal_3='$tipoAnimal3', nome_animal_1='$nome_animal1',nome_animal_2='$nome_animal2',nome_animal_3='$nome_animal3', imagem_animal_1='$foto_animal1',imagem_animal_2='$foto_animal2',imagem_animal_3='$foto_animal3', logradouro='$rua', CEP='$cep',numero='$numero',bairro='$bairro', pais='$pais',estado='$estado', cidade='$cidade',obs='$obs' where id_dono_pet = '$id';";
