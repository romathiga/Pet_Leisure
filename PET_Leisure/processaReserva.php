...
$result_data = "INSERT INTO reserva (id_dono_pet, id_prest_serv, tipo_animal, observacoes, data) VALUES ('$id_dono_pet','$id_prest_serv','$tipoanimal','$observacoes','$data_sem_barra')";
