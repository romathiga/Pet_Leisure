...
<html lang="pt-br">
	...
	<?php
	echo "<a class='p-3 mb-2 bg-primary text-white' href='HomepageUsuario.php'>Voltar a página Inicial</a><br><br>";
	
	echo "<h1>Reservas agendadas para o dia de hoje</h1>";
	...
	while($row_horarios = mysqli_fetch_array($resultado_horarios)){
      ...
      echo "Deletar Reserva: ";echo " <a class='btn btn-primary' href='deletaReservaDonoPet.php?id=$row_horarios[n_reserva]'>
