...
<html lang="pt-br">
   ...
   <!-- <script type="text/javascript" src="/js/jquery.min.js"> </script>
    ...
    <?php
		...
		?>
        <div
         class="card text-center bg-info mb-3" style="width: 35%;  margin-left: auto; margin-right: auto;" id="login">

            <form action="testeLoginUsuario.php" class="card" method="POST" >

                <div class="card-body bg-info mb-0" >
                    <img src="img/logUsuario.png" >
                </div>
